...
A simple, remote-friendly Kodi skin for browsing **your own folders** of movies and
TV - pick a folder, see a wall of posters, press play. No library flattening, no
accounts, no clutter. Built for the couch and a D-pad.
...
4. Updates arrive automatically from here on.
...
- **Folder browsing** (Files mode) - your James Bond folder, your Season folders, all
  preserved exactly as they sit on disk.
- **Poster-wall view everywhere** by default (a dense, Google-Play-style grid).
